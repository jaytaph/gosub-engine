use gosub_shared::engine::pipeline::css::DummyStylesheet;
use gosub_shared::engine::pipeline::font::DummyFont;
use gosub_shared::engine::pipeline::js::DummyJsDocument;
use gosub_shared::engine::pipeline::Hooks;
use gosub_shared::engine::types::PeekBuf;
use gosub_shared::engine::UaPolicy;
use crate::html::DummyDocument;
use crate::decision::types::BlockReason;
use crate::types::{FetchHandle, FetchRequest, FetchResult, ResourceKind};
use crate::decision::decide_handling;
use crate::shared_body::SharedBody;
use crate::utils::stream_to_bytes;
use crate::decision::types::{HandlingDecision, RenderTarget, RequestDestination};
use anyhow::anyhow;
use bytes::Bytes;
use std::sync::Arc;
