...
use gosub_interface::byte_stream::Character::Ch;
use gosub_interface::byte_stream::{ByteStream, Character};
use gosub_interface::byte_stream::{Location, LocationHandler, Stream};
