//! winit shell for the Cairo rasterizer, with softbuffer presentation.
//!
...
pub fn run(initial_url: String) {
    ...
    let setup = setup_engine(
        ...
        compositor.clone(),
        &SetupOptions {
            zone_uuid: uuid::uuid!("f1234567-abcd-4000-8000-000000000006"),
            tab_title: "Gosub",
    ...
    let mut app = BrowserApp::new(setup.engine, setup.zone, tab, tab_id, compositor, proxy, initial_url);
