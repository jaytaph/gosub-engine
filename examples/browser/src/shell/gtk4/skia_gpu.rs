//! GTK4 GLArea shell with GPU compositing of Skia CPU tiles.
//!
//! Architecture:
...
pub fn run() {
    let initial_url: String = nav::initial_url_from_args("https://example.com");
    ...
    app.connect_activate(move |app| {
        ...
        let setup = setup_engine(
            ...
            compositor.clone(),
            &SetupOptions {
                zone_uuid: uuid::uuid!("f1234567-abcd-4000-8000-00000000000d"),
                tab_title: "Gosub",
